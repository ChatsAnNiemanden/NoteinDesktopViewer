; Inno Setup Script for NoteinDesktopViewer (ARM64)
...
OutputBaseFilename=NoteinDesktopViewer-arm64Setup
...
Source: "bin\Release\net10.0\win-arm64\publish\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "*.pdb"
